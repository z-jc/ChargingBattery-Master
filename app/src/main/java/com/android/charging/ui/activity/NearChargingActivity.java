 ...
 * @class describe
 */
public class NearChargingActivity extends BaseActivity implements OnLoadMoreListener,
        OnRefreshListener {
    ...
    public NearChargingAdapter adapter;

    public static Intent newIntent(Activity activity) {
        Intent intent = new Intent(activity, NearChargingActivity.class);
        return intent;
    }
    ...
    private void initView() {
        ...
        tvTitle.setText("附近电站");

        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new NearChargingAdapter(this);
        ...
        NearChargingBean bean = new NearChargingBean();
        bean.setTitle("正弘数码港");
        bean.setName("正弘数码港");
        bean.setIdleNumber("9个");
        bean.setFulNumber("1个");
        bean.setSumNumber("10个");
        bean.setTotal("15.23KM");
        List<NearChargingBean> list = new ArrayList<>();
        list.add(bean);
