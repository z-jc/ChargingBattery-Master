...
public class QrConfig implements Serializable {
    ...
    public final static int TYPE_IDENTIFY = 1;//连续扫描
    public final static int TYPE_ONCE = 2;//一次性扫码

    public int identify_type = 1;//识别类型  1：连续扫码,2单次扫码

    public int getIdentify_type() {
        return identify_type;
    }

    public void setIdentify_type(int identify_type) {
    ...
    public static class Builder{
        ...
        public Builder setIdentify_type(int identify_type){
            watcher.identify_type = identify_type;
            return this;
        }
